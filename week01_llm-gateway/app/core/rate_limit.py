...
class InMemoryRateLimiter:
    ...
    The implementation intentionally stays small and independent. For multi-replica
    deployments this should be replaced by a Redis-backed implementation.
    """
    ...
    async def check(self, identity: str) -> None:
        ...
        async with self._lock:
            ...
            bucket.tokens = min(
                capacity,
                bucket.tokens + (now - bucket.updated_at) * refill_per_second,
            )
