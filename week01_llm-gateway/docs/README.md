...
本目录用于沉淀 LLM 统一模型调用服务在设计、决策、拆解和验收阶段的文档。当前共五个文档，建议按“需求 → 设计 → 决策 → 任务拆解 → 验收测试”的顺序阅读。
...
| [test-plan.md](./test-plan.md) | 验收测试计划。定义整模块验收范围、mock 上游方案、功能场景和具体验证内容。 |
...
5. 验收前看 [test-plan.md](./test-plan.md)，确认验收范围、Mock 策略和通过标准。
